    ...
    if($validate->is_valid)
        ...
        $mailgun->sendMessage(MAILGUN_DOMAIN, [
            ...
            'html' => "Hello {$name},<br><br>
                        You have signed up for our subscription.Please confirm below.<br><br>http://localhost/minor/api/mailinglist/confirm.php?hash={$hash}"
...
?>
    ...
    <head>
        ...
        <script src="../../site/library/js/vendor/modernizr.js"></script>
        <link href="style.css" type="text/css" rel="stylesheet" media="screen,projection" />
        <!--        <script src="application/apiservices.js"></script>-->
        <script src="../../site/library/js/jquery-1.11.3.min.js"></script>
    </head>
